...
<body class="body1"  style="  background:fixed url(./image/bg1.jpg);background-size: 100%;">
	<center><div class="bars">
        ...
        <h3>Medium</h3>
        <div class="md">
		<div class="divp35"><input <?php $medium1=strstr($medium, "kiswahili"); if($medium1 != '') echo 'checked'; ?> type="radio" name="medium_list[]" id="md" value="kiswahili"><span>Kis</span></div>
