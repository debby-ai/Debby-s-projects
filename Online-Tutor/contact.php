        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Kabarak University</div>
              <div class="text-two">Nakuru</div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">+254712029559</div>
              <div class="text-two">+254712029559</div>
            </div>
          ...
          <form action="mailto:bgavole@kabarak.ac.ke" enctype="text/plain" method="post">
            <div class="input-box">
